...
> Coffee House is a website created with HTML, SCSS, and TypeScript. It utilizes linters to overcome code errors and maintain clean code. An array object is in use, along with animations and effects. Please check out the live demo.
